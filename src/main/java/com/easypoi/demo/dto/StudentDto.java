...
public class StudentDto implements java.io.Serializable {
    ...
    public StudentDto(long id, @NotBlank(message = "该字段不能为空") String serialNumber, @Pattern(regexp = "[\\u4E00-\\u9FA5]{2,5}", message = "姓名中文2-5位") String name, @NotBlank(message = "该字段不能为空") String admissionNumber, @Pattern(regexp = "^((13[0-9])|(14[5|7])|(15([0-3]|[5-9]))|(17[013678])|(18[0,5-9]))\\\\d{8}$", message = "手机号码格式错误") String phone, @NotBlank(message = "该字段不能为空") String schoolCode, String schoolName) {
        this.id = id;
